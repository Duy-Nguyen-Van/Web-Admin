            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-star-half-o fa-fw"></i>Store<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('admin.store.list')}}">List Store</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.store.getAdd')}}">Add Store</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
